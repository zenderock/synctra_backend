...
from app.api.v1.endpoints import auth, projects, links, analytics, referrals, deferred

api_router = APIRouter()

api_router.include_router(auth.router, prefix="/auth", tags=["authentification"])
api_router.include_router(projects.router, prefix="/projects", tags=["projets"])
api_router.include_router(links.router, prefix="/projects/{project_id}/links", tags=["liens"])
